# Не дает закоммитить import random там где надо,поэтому первый
# import random по умолчанию для всех где нужен.
...
# 11. Ищите слова "стоп" в списке.Если слово наидено,остановите цикл
#     и вывидите,сколько слов было до него.

words = ["начало", "путь", "стоп", "дальше", "конец"]

for i in words:
    if i == "стоп":
        print(words[0:words.index(i)])
